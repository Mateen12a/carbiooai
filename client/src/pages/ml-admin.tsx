      ...
      >
        ...
        <Alert className="mb-6">
          ...
          <AlertDescription>
            ...
            This page shows models that have been synced to Carbioo AI for use in material scanning.
          </AlertDescription>
        </Alert>
          ...
          <CardContent>
            {modelsLoading ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p>No models found.</p>
                <p className="text-sm mt-2">Use MLStudio to train and sync models to Carbioo AI.</p>
              </div>
            ) : (
