...
export default function ApiDocs() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('curl -X POST https://api.carbioo.ai/v1/analyze \\ \n  -H "Authorization: Bearer YOUR_API_KEY" \\ \n  -F "image=@material.jpg"');
    setCopied(true);
            ...
            <div className="md:w-1/3 space-y-6">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Integrate Carbioo AI's powerful material analysis engine directly into your own applications.
                    </p>
                </div>
                ...
                <section id="analyze" className="space-y-6">
                    ...
                    <Card className="bg-slate-950 border-slate-800 text-slate-300 overflow-hidden">
                        ...
                        <CardContent className="p-4 font-mono text-sm overflow-x-auto">
                            <pre>
{`curl -X POST https://api.carbioo.ai/v1/analyze \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -F "image=@material.jpg"`}
                            </pre>
                        </CardContent>
