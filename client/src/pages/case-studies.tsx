  ...
  const studies = [
    {
        ...
        description: "How Carbioo AI helped reduce embodied carbon by 40% using hempcrete alternatives for non-load bearing walls.",
        metric: "-40% Carbon",
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
                See how leading architects are using Carbioo AI to design the next generation of sustainable buildings.
            </p>
        </div>
